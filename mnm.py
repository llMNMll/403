...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="Example: python3 bypass.py -u urls.txt -ua user_agents.txt"
    )
    ...
    parser.add_argument("--threads", type=int, default=5, help="Number of threads for parallel testing")
